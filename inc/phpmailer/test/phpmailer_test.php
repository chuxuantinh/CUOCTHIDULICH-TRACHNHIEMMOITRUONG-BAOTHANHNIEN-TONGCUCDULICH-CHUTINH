...
class phpmailerTest extends TestCase
{
    ...
    function setUp() {
        ...
        $this->Mail->From = "ithotro@saigonact.edu.vn";
        ...
        $this->Mail->Host = $global_vars["smtp.gmail.com"];
        $this->Mail->Port = 465;
        $this->Mail->Helo = "smtp.gmail.com";
        $this->Mail->SMTPAuth = true;
        $this->Mail->Username = "ithotro@saigonact.edu.vn";
        $this->Mail->Password = "Thuquyenru2000";
        $this->Mail->PluginDir = $INCLUDE_DIR;
		$this->Mail->AddReplyTo("ithotro@saigonact.edu.vn", "Reply Guy");
        $this->Mail->Sender = "ithotro@saigonact.edu.vn";
        ...
        else
        {
            ...
            $this->Sender = "ithotro@saigonact.edu.vn";
        }
