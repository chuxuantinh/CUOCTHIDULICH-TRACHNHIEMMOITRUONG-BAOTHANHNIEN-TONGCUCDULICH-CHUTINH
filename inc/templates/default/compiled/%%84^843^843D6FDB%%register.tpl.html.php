...
<table class=rowtable2 cellpadding=4 cellspacing=1 border=0 width="100%">
...
<script type="text/javascript" src="countries.js"></script>
	    ...
	    <select onchange="print_state('cstate',this.selectedIndex);" id="country" name ="country"  style="width:330px;"></select>
	  ...
	  <tr class="rowtwo" valign="top">
<td>
Trường học THPT của bạn: (lưu ý chọn tỉnh/thành phố trước để chọn trường THPT)
<font color="#800000">*</font>
</td>
<td>

        <select name ="cstate" id ="cstate" class="inp" style="width:390px;></select><span class="error">* </span>
...
<?php echo $this->_tpl_vars['g_vars']['page']['items']['testid_input']; ?>
	...
	<p>
	<input class=btn type=submit name=bsubmit value=" <?php echo $this->_tpl_vars['lngstr']['button_register']; ?>
 "></form>
