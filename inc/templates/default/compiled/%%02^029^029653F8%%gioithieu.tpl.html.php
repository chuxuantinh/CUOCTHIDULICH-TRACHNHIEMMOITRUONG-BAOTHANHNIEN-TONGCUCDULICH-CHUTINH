...
<tr  style="background: #0066CC repeat-x;">
<td width=1 style="background: #ffffff"><img src="images/1x1.gif" width=1 height=32></td>
<td align=center><b><a class= style="color:#FFFFFF" href="Gioithieu.php"><?php echo $this->_tpl_vars['lngstr']['gioithieu']; ?></a></b></td>
